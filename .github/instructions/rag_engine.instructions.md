...
- **No UI / crawler imports.** `rag_engine` must not import `streamlit`, `crawl4md_streamlit`, or `crawl4md`. It may depend on `vector_indexer`, `artifact_store`, and `pydantic`. A boundary test enforces this.
