...
class TestMoreLinkPreserved:
    ...
    def test_more_link_appended(self):
        text = (
            ...
            "New\n\nSamsung Galaxy S26 Ultra 5G\n\nfrom $78.00/mth\n\n"
            "12 offers available\n\n"
            f"[{_WRAPPER_LINK_TEXT}](https://example.com/devices/samsung/galaxy-s26-ultra-5g)\n\n"
            "---\n\n"
            "iPhone 17 Pro\n\nfrom $72.87/mth\n\n"
            "12 offers available\n\n"
            f"[{_WRAPPER_LINK_TEXT}](https://example.com/devices/apple/iphone-17-pro)\n\n"
            "---\n\n"
            "Pixel 10 Pro\n\nfrom $65.00/mth\n\n"
            "10 offers available\n\n"
            f"[{_WRAPPER_LINK_TEXT}](https://example.com/devices/google/pixel-10-pro)\n\n"
            "---"
        )
        result = ContentExtractor._reformat_separated_items(text)
        assert "- **Samsung Galaxy S26 Ultra 5G**" in result
    ...
    def test_more_link_not_used_as_name(self):
        ...
        text = (
            "---\n\n"
            f"[{_WRAPPER_LINK_TEXT}](https://example.com/devices/phone)\n\n"
            "from $78.00/mth\n\n"
            "---\n\n"
            "iPhone 17 Pro\n\nfrom $72.87/mth\n\n"
            f"[{_WRAPPER_LINK_TEXT}](https://example.com/devices/iphone)\n\n"
            "---\n\n"
            "Pixel 10\n\nfrom $55.00/mth\n\n"
            f"[{_WRAPPER_LINK_TEXT}](https://example.com/devices/pixel)\n\n"
            "---"
        )
        result = ContentExtractor._reformat_separated_items(text)
        # The more link should not be the bolded name
        assert f"- **[{_WRAPPER_LINK_TEXT}]" not in result
