...
class Strings(TypedDict):
    ...
    CONV_PROMPTS_LABEL: str
    CONV_PROMPT_TAB_ANSWER: str
    CONV_PROMPT_TAB_DECOMPOSE: str
    CONV_PROMPT_TAB_RERANK: str
    CONV_PROMPT_TAB_FOLLOWUPS: str
    CONV_PROMPT_TAB_ANSWERABILITY: str
    CONV_PROMPT_TAB_STATE: str
    CONV_PROMPT_TAB_WELCOME: str
    CONV_PROMPT_TAB_ERROR_REPLY: str
    CONV_PROMPT_TAB_FOLLOWUP_INTRO: str
    CONV_PROMPT_TAB_NO_FOLLOWUPS: str
    CONV_PROMPT_FIELDS_CAPTION: str  # template: {fields}
    CONV_PROMPT_WELCOME_CAPTION: str
    CONV_PROMPT_ERROR_REPLY_CAPTION: str
    CONV_PROMPT_FOLLOWUP_INTRO_CAPTION: str
    CONV_PROMPT_NO_FOLLOWUPS_CAPTION: str
    CONV_ERROR_REPLY_DEFAULT: str
    CONV_FOLLOWUP_INTRO_DEFAULT: str
    CONV_NO_FOLLOWUPS_DEFAULT: str
    CONV_PROMPT_SAVE: str
    CONV_PROMPT_RESET: str
    CONV_PROMPT_SAVED_TOAST: str
    CONV_PROMPT_RESET_TOAST: str
    CONV_PROMPT_INVALID: str  # template: {fields}
    ...
    CONV_TAB_DIAGNOSTICS: str
    CONV_DIAGNOSTICS_EMPTY: str
    ...
    CONV_INSPECT_RETRIEVAL_HELP: str
    CONV_INSPECT_RETRIEVAL_BYQUERY: str
    ...
    CONV_INSPECT_STATE_HELP: str
    CONV_INSPECT_FOLLOWUPS_NONE: str
    CONV_INSPECT_FOLLOWUPS_HELP: str
    CONV_INSPECT_PROMPT_LABEL: str
    CONV_INSPECT_RESPONSE_LABEL: str
    CONV_INSPECT_NO_PROMPT: str
    CONV_INSPECT_ANSWERABILITY_PROBE: str  # template: {n}
    CONV_META_PLAN: str
    ...
    CONV_PROCESS_DECOMPOSITION: str
    CONV_PROCESS_RERANKING: str
    CONV_PROCESS_ANSWER: str
    CONV_PROCESS_FOLLOWUPS: str
    CONV_PROCESS_ANSWERABILITY: str
    CONV_PROCESS_STATE: str
    CONV_PROCESS_MULTI: str
    CONV_TXN_COL_CONVERSATION: str
    CONV_TXN_COL_TRANSACTION: str
