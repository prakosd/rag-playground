...
STRINGS_ID: Strings = {
    ...
    "CHART_SPEED_TITLE": "Upaya halaman per detik",
    ...
    "CHART_SERIES_SPEED": "Upaya halaman per detik",
    "CHART_SPEED_TITLE_SECOND": "Upaya halaman per detik (rata-rata 1 detik)",
    "CHART_SPEED_TITLE_MINUTE": "Upaya halaman per detik (rata-rata 1 menit)",
    "CHART_SPEED_TITLE_HOUR": "Upaya halaman per detik (rata-rata 1 jam)",
