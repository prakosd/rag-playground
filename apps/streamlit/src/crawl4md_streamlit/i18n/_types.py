...
class Strings(TypedDict):
    ...
    QA_HISTORY_PIN_HELP: str
    QA_HISTORY_UNPIN_HELP: str
    QA_HISTORY_LABEL_QUESTION: str
    QA_HISTORY_LABEL_TIME: str
    QA_HISTORY_DETAILS_EXPANDER: str
    QA_HISTORY_PROMPT_EXPANDER: str
    QA_HISTORY_ANSWER_EXPANDER: str
    QA_HISTORY_META_INDEX_NAME: str
    QA_HISTORY_META_INDEX_DATE: str
