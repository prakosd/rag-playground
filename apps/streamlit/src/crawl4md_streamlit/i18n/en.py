...
STRINGS_EN: Strings = {
    ...
    "CHART_SPEED_TITLE": "Page attempts per second",
    ...
    "CHART_SERIES_SPEED": "Page attempts per second",
    "CHART_SPEED_TITLE_SECOND": "Page attempts per second (1-second average)",
    "CHART_SPEED_TITLE_MINUTE": "Page attempts per second (1-minute average)",
    "CHART_SPEED_TITLE_HOUR": "Page attempts per second (1-hour average)",
