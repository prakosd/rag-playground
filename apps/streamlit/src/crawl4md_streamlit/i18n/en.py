...
STRINGS_EN: Strings = {
    ...
    "SEARCH_HISTORY_COL_TIME": "Date & time",
    "SEARCH_HISTORY_COL_INDEX": "Vector DB",
    "SEARCH_HISTORY_COL_QUERY": "Query",
    "SEARCH_HISTORY_COL_OPTIONS": "Options",
    "SEARCH_HISTORY_COL_RESULTS": "Results",
    "SEARCH_HISTORY_COL_ACTION": "Again",
