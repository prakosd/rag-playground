...
timing/direction) while the link is unselected (a link to a **failed page** looks the same as any
other — a failed page is set apart **only** by its asteroid shape, not by link colour, glow, or
bloom). Hovering a
