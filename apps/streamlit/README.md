...
timing/direction) while the link is unselected — except a link to a **failed page**, which stays
**red** so each asteroid is easy to trace back to its parent. Hovering a
