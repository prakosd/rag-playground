...
| `focus.py` | Client-side focus helpers: `focus_widget` (focus a keyed input after a rerun, e.g., after a history replay), `entered_page` (tracks page navigation), and `scroll_to_bottom` (nudge a keyed scroll container to its latest turn) |
